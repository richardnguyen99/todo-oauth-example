            ...
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3">
              <div className="bg-background flex flex-col justify-between rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    &ldquo;TaskMaster has completely transformed how I manage my
                    daily tasks. I&apos;m more productive than ever!&rdquo;
                  </p>
                </div>
              ...
              <div className="bg-background flex flex-col justify-between rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    &ldquo;The collaboration features are game-changing. My team
                    can now work together seamlessly on projects.&rdquo;
                  </p>
                </div>
                <div className="mt-6 flex items-center space-x-3">
                  <Image
              ...
              <div className="bg-background flex flex-col justify-between rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    &ldquo;I&apos;ve tried many todo apps, but TaskMaster is by
                    far the most intuitive and feature-rich. Highly
                    recommend!&rdquo;
                  </p>
                </div>
                <div className="mt-6 flex items-center space-x-3">
